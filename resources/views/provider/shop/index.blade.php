    ...
    <div class="space-y-5 sm:space-y-6">
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="border-t border-gray-100 p-5 dark:border-gray-800 sm:p-6">
                <!-- ====== DataTable One Start -->
                <div x-data="dataTable({{ $shops->toJson() }})"
                    ...
                    <div class="max-w-full overflow-x-auto">
                        <div class="min-w-[1102px]">
                            ...
                            <!-- table header end -->
                            <div x-data="{
                                paginatedData: @json($shops),
                            }">
                                <!-- table body start -->
                                <template x-for="shop in paginatedData" :key="shop.id">
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-3">
                                                <div class="h-10 w-10 overflow-hidden rounded-full">
                                                  <img :src="shop.image" alt="shop Image" class="h-full w-full object-cover" />

                                                </div>
                                                <div>
                                                    <span
                                                        class="block text-theme-sm font-medium text-gray-800 dark:text-white/90"
                                                        x-text="shop.name"></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div
                                            ...
                                            <p class="text-theme-sm text-gray-700 dark:text-gray-400"
                                                x-text="shop.sub_title || 'No Subtitle'"></p>
                                        </div>

                                         <div class="col-span-2 flex items-center px-4 py-[17.5px]">
                                            <div class="flex w-full items-center gap-2">
                                            <a href="#" class="text-gray-500 hover:text-error-500 dark:text-gray-400 dark:hover:text-error-500 delete-btn"    :data-id="shop.id">
                                            ...
                                            <a :href="`{{ route('shops.edit', ':id') }}`.replace(':id', shop.id)" class="text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white/90">
                                                <svg class="fill-current" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script>
    const deleteRouteTemplate = @json(route('shops.destroy', ['shop' => '__id__']));
</script>
<script>
    $(document).ready(function () {
        $('.delete-btn').on('click', function (e) {
            ...
            const deleteUrl = deleteRouteTemplate.replace('__id__', courseId);
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: deleteUrl,
                        type: 'POST', // Since HTML form only supports GET/POST
                        data: {
