...
<div class="mx-auto max-w-7xl p-4 md:p-6">
    ...
    <div>
        <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
            <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90">Edit Shop</h2>
            <nav>
                <ol class="flex items-center gap-1.5">
                    ...
                    <li class="text-sm text-gray-800 dark:text-white/90">Edit Shop</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="col-span-12 space-y-6">
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                        ...
                        <input type="text" name="name" placeholder="Enter Your Shop Name" value="{{ $shop->name }}"
                      ...
                      <!-- Sub-title -->
                        <div>
                            ...
                            <input type="text" name="sub_title" placeholder="Enter Your subtitle" value="{{ $shop->sub_title }}"
                        ...
                        <div>
                            ...
                            <textarea id="summernote" name="description" placeholder="Enter Your Description">{!! $shop->description !!}</textarea>
                        </div>
