                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-3">
                                                <div class="h-10 w-10 overflow-hidden rounded-full">
                                                  <img :src="blog.image" alt="blog Image" class="h-full w-full object-cover" />

                                                </div>
                                                <div>
                                                    <span
                                                        class="block text-theme-sm font-medium text-gray-800 dark:text-white/90"
                                                        x-text="blog.name"></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div
                                            ...
                                            <p class="text-theme-sm text-gray-700 dark:text-gray-400"
                                                x-text="blog.name || 'No Title'"></p>
                                        </div>

                                         <div class="col-span-2 flex items-center px-4 py-[17.5px]">
                                            <div class="flex w-full items-center gap-2">
                                            <a href="#" class="text-gray-500 hover:text-error-500 dark:text-gray-400 dark:hover:text-error-500 delete-btn"    :data-id="blog.id">
                                            ...
                                            <a :href="`{{ route('blogs.edit', ':id') }}`.replace(':id', blog.id)" class="text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white/90">
                                                <svg class="fill-current" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script>
    const deleteRouteTemplate = @json(route('blogs.destroy', ['blog' => '__id__']));
</script>
<script>
