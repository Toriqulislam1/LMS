          ...
          <div class="col-md-8">
            <div class="widget no-border m-0">
              <ul class="list-inline">
                ...
                <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-white"></i> <a class="text-white" href="#"><span class="__cf_email__" data-cfemail="a6c5c9c8d2c7c5d2e6dfc9d3d4c2c9cbc7cfc888c5c9cb">[email&#160;protected]</span></a> </li>
              </ul>
            </div>
          </div>
          <div class="col-md-4">
            ...
            <div class="sidebar sidebar-left mt-sm-30">
              ...
              <div class="widget">
                ...
                <div id="flickr-feed" class="clearfix">
                  <!-- Flickr Link -->
                  <script type="text/javascript" src="https://www.flickr.com/badge_code_v2.gne?count=8&amp;display=latest&amp;size=s&amp;layout=x&amp;source=user&amp;user=52617155@N08">
                  </script>
                </div>
              </div>
            </div>
        ...
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            ...
            <ul class="list-border">
              ...
              <li><a href="#"><span class="__cf_email__" data-cfemail="94fcf1f8f8fbd4edfbe1e6f0fbf9f5fdfabaf7fbf9">[email&#160;protected]</span></a></li>
